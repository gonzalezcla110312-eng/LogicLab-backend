...
export const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/mesas/{id}/pedido-activo': {
      ...
      get: {
        tags: ['Mesas y pedidos'],
        summary: 'Obtener pedido activo de una mesa',
        security: [{ bearerAuth: [] }],
        responses: {
          200: securedResponse
        }
    ...
    '/api/mesas/pedidos/activos/cocina': {
      get: {
        tags: ['Mesas y pedidos'],
        summary: 'Listar pedidos activos para cocina',
        security: [{ bearerAuth: [] }],
        responses: {
          200: securedResponse
        }
    ...
    '/api/mesas/pedidos/{pedidoId}': {
      ...
      put: {
        tags: ['Mesas y pedidos'],
        summary: 'Actualizar pedido activo',
        security: [{ bearerAuth: [] }],
    ...
    '/api/menu-dia/hoy': {
      get: {
        tags: ['Menu del dia'],
        summary: 'Obtener menu del dia actual',
        responses: {
          200: securedResponse
        }
      }
    ...
    '/api/menu-dia': {
      get: {
        tags: ['Menu del dia'],
        summary: 'Listar menus por rango de fechas',
    ...
    '/api/menu-dia/{fecha}': {
      ...
      get: {
        tags: ['Menu del dia'],
        summary: 'Obtener menu por fecha',
        responses: {
          200: securedResponse
        }
      },
      ...
      put: {
        tags: ['Menu del dia'],
        summary: 'Crear o actualizar menu del dia',
        security: [{ bearerAuth: [] }],
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/DailyMenuRequest'
              }
            }
          }
        },
    ...
    '/api/menu-dia/limpiar': {
      delete: {
        tags: ['Menu del dia'],
        summary: 'Limpiar menus por rango',
        parameters: dateRangeParameters,
        security: [{ bearerAuth: [] }],
        responses: {
          200: securedResponse
    ...
    '/api/admin/dashboard/tendencia-pedidos': {
      get: {
        tags: ['Dashboard administrativo'],
        summary: 'Obtener tendencia de pedidos',
        parameters: dateRangeParameters,
        security: [{ bearerAuth: [] }],
        responses: {
          200: securedResponse
    ...
    '/api/admin/dashboard/mesas-ocupadas': {
      get: {
        tags: ['Dashboard administrativo'],
        summary: 'Obtener mesas ocupadas',
        security: [{ bearerAuth: [] }],
        responses: {
          200: securedResponse
        }
    ...
    '/api/admin/dashboard/platillos-top': {
      get: {
        tags: ['Dashboard administrativo'],
        summary: 'Obtener platillos mas vendidos',
    ...
    '/api/admin/dashboard/alertas-pedidos': {
      get: {
        tags: ['Dashboard administrativo'],
        summary: 'Obtener alertas de pedidos',
    ...
    '/api/pqrs/tipos': {
      get: {
        tags: ['PQRS'],
        summary: 'Listar tipos de PQRSF',
        responses: {
          200: securedResponse,
          500: {
            description: 'Error al consultar los tipos de PQRSF'
          }
        }
      }
    }
  ...
  components: {
    securitySchemes: {
      bearerAuth: {
        ...
        scheme: 'bearer',
        bearerFormat: 'JWT',
        description: 'Token JWT obtenido en /api/usuarios/login'
      }
    },
